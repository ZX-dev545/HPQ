        ...
        protected class Tile : Control
        {
            ...
            public class Group
            {
                ...
                public int underage
                {
                    get
                    {
                        return Math.Max(sort.qsort(pieces, a => a.offset)[0].Item2, sort.qsort(pieces, a =>
                        {
    ...
    partial class Window
    {
                ...
                bool IsLike<T>(T a, T b) where T : IFormulaic
                {
                    switch (a)
                    {
                        ...
                        case IFormulaic t when b is Term && t is Term:
                            var t1 = (from A in (b as Term).SeparateCoefficient.Item2.Variables
                                      where A.name != null
                                      from B in (t as Term).SeparateCoefficient.Item2.Variables
                                      where B.name != null
        ...
        protected class Function : IFormulaic, IVariable
        {
            ...
            public Function(IContainer container, string name, List<Formula> prms, Formula value, Formula index = null)
            {
                ...
                ParameterNames = (from p in prms
                                  where p.AddedVariables.All(a => a.name != null) && p.AddedVariables.Count() > 0
...
namespace Liber //The Liber Engine at the state it was in when this ws finished (future versions might not be compatible)
{
    /// <summary>
    ...
    public class Engine : Form
    {
        ...
        protected class pontus : figura, mathematica
        {
            ...
            public pontus rv() { var cout = dcpy(this); cout.rx = x; cout.ry = y; cout.rz = z; return cout; }
            ...
            //mathematicae
            public List<double> pares() { return new List<double> { x, y, z }; }
 ...
 in ponti) { cout.Add(new PointF((float)p.rx, (float)p.ry)); }
        ...
        protected struct vector : mathematica
        {
            ...
            //mathematicae
            public List<double> pares() { return partes; }
        ...
        protected struct planus : mathematica
        {
            ...
            //mathematicae
            public List<double> pares() { return new List<double> { a, b, c, w }; }
        ...
        protected struct quaternion : mathematica, species
        {
            ...
            //mathematicae
            public List<double> pares() { return new List<double> { w, i, j, k }; }
